...
export const metadata: Metadata = {
  title: "Contact A Cockie Clikker Support",
  description: "Have questions, feedback, or need support for A Cockie Clikker? Get in touch with our team directly.",
}
...
<section className="relative w-full overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6 md:py-32 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-muted-foreground">We'd love to hear from you. Whether it's feedback, support, or just to say hello, reach out!</p>
...
<section className="relative w-full ">
      <div className="mx-auto max-w-5xl px-4 py-20 text-center sm:px-6 md:py-24 lg:px-8">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-pretty text-muted-foreground">Stay updated with new features, events, and high score announcements on our social media!</p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Button asChild size="lg"><Link href="https://twitter.com/cockieclikker">Follow Us on Twitter</Link></Button>
