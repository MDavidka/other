...
export const siteConfig = {
  "name": "other",
  "tagline": "Blazing Fast, Unwavering Reliability. Your Digital Presence, Elevated.",
  ...
  "audience": "Small businesses, developers, agencies, and e-commerce stores seeking high-performance, reliable, and secure web hosting.",
  "category": null,
  ...
  "footerCta": {
    "label": "Start Your Hosting Journey Today",
    "href": "/pricing"
  },
  "socialLinks": [
    {
      "label": "Twitter",
      "href": "https://twitter.com/cloudwave"
    },
    {
      "label": "LinkedIn",
      "href": "https://linkedin.com/company/cloudwave"
    },
    {
      "label": "Facebook",
      "href": "https://facebook.com/cloudwave"
    }
  ],
  "contact": {
    "email": "support@cloudwave.com",
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "Persistent storage for user accounts, hosting plans, billing information, and system configurations.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
