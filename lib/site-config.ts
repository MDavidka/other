...
export const siteConfig = {
  "name": "other",
  "tagline": "Your Next Device, Seamlessly Delivered.",
  ...
  "audience": "Tech enthusiasts, everyday smartphone users, gadget lovers seeking quality and convenience.",
  "category": null,
  ...
  "footerCta": {
    "label": "Find Your Perfect Device",
    "href": "/shop"
  },
  "socialLinks": [
    {
      "label": "Twitter",
      "href": "https://twitter.com/connectdevices"
    },
    {
      "label": "Instagram",
      "href": "https://instagram.com/connectdevices"
    },
    {
      "label": "Facebook",
      "href": "https://facebook.com/connectdevices"
    }
  ],
  "contact": {
    "email": "support@connectdevices.com",
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "To manage product catalog, customer orders, user accounts, and inventory data securely.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
