...
export const siteConfig = {
  "name": "other",
  "tagline": "Curated Essentials for a Modern Lifestyle",
  ...
  "audience": "Conscious consumers seeking quality, design, and ethical sourcing for home goods, fashion, and personal care.",
  "category": null,
  ...
  "socialLinks": [
    ...
    {
      "label": "Facebook",
      "href": "https://facebook.com/other"
    },
    {
      "label": "Pinterest",
      "href": "https://pinterest.com/other"
    }
  ],
  "contact": {
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "To store product inventory, customer orders, user accounts, and content for a dynamic webshop.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
