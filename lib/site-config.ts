...
export const siteConfig = {
  "name": "other",
  "tagline": "Your next device, delivered with expertise.",
  ...
  "audience": "Tech-savvy individuals and everyday users seeking reliable mobile devices and accessories, valuing quality and customer support.",
  "category": null,
  ...
  "socialLinks": [
    {
      "label": "Twitter",
      "href": "https://twitter.com/mobilehub"
    },
    {
      "label": "Instagram",
      "href": "https://instagram.com/mobilehub"
    },
    {
      "label": "Facebook",
      "href": "https://facebook.com/mobilehub"
    }
  ],
  "contact": {
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "To manage product inventory, customer orders, user accounts, and reviews efficiently.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
