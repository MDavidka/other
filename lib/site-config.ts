...
export const siteConfig = {
  ...
  "audience": "Discerning individuals, design enthusiasts, those seeking quality over quantity, conscious consumers.",
  "category": null,
  ...
  "socialLinks": [
    {
      "label": "Instagram",
      "href": "https://instagram.com/auraatelier"
    },
    {
      "label": "Pinterest",
      "href": "https://pinterest.com/auraatelier"
    }
  ],
  "contact": {
    "email": "hello@auraatelier.com"
  },
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "To store product information, customer orders, and user accounts.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
