...
export const siteConfig = {
  "name": "other",
  "tagline": "Discreet Pleasure, Delivered Fast",
  ...
  "audience": "Adults 21+ seeking quality intimate products with privacy and convenience",
  "category": null,
  ...
  "footerCta": {
    "label": "Get 15% Off First Order",
    "href": "/shop"
  },
  "socialLinks": [
    {
      "label": "Instagram",
      "href": "https://instagram.com/otherpleasures"
    }
  ],
  "contact": {
    "email": "hello@otherpleasures.com"
  },
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "Store products, categories, orders, user carts, and order history",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
