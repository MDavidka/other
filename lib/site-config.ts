...
export const siteConfig = {
  "name": "other",
  "tagline": "Click Your Way to a Cookie Empire!",
  ...
  "audience": "Casual gamers, idle game enthusiasts, anyone looking for a fun, low-stress distraction.",
  "category": null,
  ...
  "footerCta": {
    "label": "Join the Cookie Community",
    "href": "/community"
  },
  "socialLinks": [
    {
      "label": "Twitter",
      "href": "https://twitter.com/cockieclicker"
    },
    {
      "label": "Discord",
      "href": "https://discord.gg/cockieclicker"
    }
  ],
  "contact": {
    "email": "support@cockieclicker.com"
  },
  "themePreset": "creator",
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "To store user game progress, scores, upgrades, and leaderboard data.",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
