...
export const siteConfig = {
  "name": "other",
  "tagline": "Deploy static sites in seconds",
  ...
  "audience": "developers and indie teams shipping static sites",
  "category": null,
  ...
  "integrations": [
    {
      ...
      "name": "Turso",
      "provider": "turso",
      "reason": "Store deployments, domains, and user projects",
      "envVars": [
        "TURSO_DATABASE_URL",
        "TURSO_AUTH_TOKEN"
      ]
